...
[`minimal.py`](minimal.py)透過 Python SDK 執行該組合，並把 `DSH_MODEL` 作為預設模型。[Python SDK 教程](../../docs/user/guide/python-sdk.md)介紹安裝、執行、workspace 選擇與 session 標識；[SDK 參考](../../python/sdk/README.md)歸屬執行時期生命週期與結果語義。
