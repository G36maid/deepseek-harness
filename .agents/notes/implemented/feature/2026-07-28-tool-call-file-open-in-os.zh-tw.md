...
[English](2026-07-28-tool-call-file-open-in-os.md) | 繁體中文

## 問題

聊天工具行把整行摘要當作點擊目標，點擊後打開右側 details 面板，並帶有整行懸停背景。對檔案系統工具而言，有用的動作是用作業系統預設應用打開所涉文件，而不是在側欄裡查看原始工具載荷。
